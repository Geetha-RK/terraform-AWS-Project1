resource "aws_instance" "web" {
  ...
  #!/bin/bash
    ...
    echo "        @import url('https://linkprotect.cudasvc.com/url?a=https%3a%2f%2ffonts.googleapis.com%2fcss%3ffamily%3dOpen%2bSans%26display%3dswap&c=E,1,lKi36C_n5ZoYCSYbz95mcInX3qxk0yNKaqYTXefh3S1fK-NpgRZU4D6zqEd0cA4O7f2ZtpIyZPcKvBi-40YvOR4gjz4PuoW6ON2LyFGE3E-m804,&typo=1');" >> index.html
